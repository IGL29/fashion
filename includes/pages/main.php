<main class="shop-page">
  ...
  <section class="shop container">
    <section class="shop__filter filter">
      <?php
        include $_SERVER['DOCUMENT_ROOT'] . '/templates/filters.php';
      ?>
    </section>
    ...
    <div class="shop__wrapper">
      <section class="shop__sorting">
        <div class="shop__sorting-item custom-form__select-wrapper">
          <select class="custom-form__select" value="<?=isset($_GET['sort']) && $_GET['sort'] === 'price' || 'name' ? $_GET['sort'] : '' ?>" name="sort">
      ...
      <ul id="paginator" class="shop__paginator paginator">
        <li>
          <a class="paginator__item" data-number="1">1</a>
        </li>
        <li>
          <a class="paginator__item" data-number="2">2</a>
        </li>
      </ul>
    </div>
  </section>
